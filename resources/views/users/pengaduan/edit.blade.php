            ...
            <div class="p-6 bg-white shadow sm:rounded-lg">
                <form action="{{ route('pengaduan.update', $pengaduan->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="judul" class="w-full mt-1 form-input" value="{{ $pengaduan->judul }}"
                            required>
                    </div>

                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700">Isi Pengaduan</label>
                        <textarea name="isi_pengaduan" class="w-full mt-1 form-textarea" rows="4"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="status" class="w-full mt-1 bg-gray-100 cursor-not-allowed form-input"
                            value="{{ $pengaduan->status }}" readonly>
                    </div>
